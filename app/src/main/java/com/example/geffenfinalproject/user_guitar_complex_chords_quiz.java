...
public class user_guitar_complex_chords_quiz extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_guitar_complex_chords_quiz);
    ...
    private int getNoteResId(int noteIdx, int octave) {
        ...
        // Final fallback to piano if still 0
        if (resId == 0) {
